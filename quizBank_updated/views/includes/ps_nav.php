	<nav class="navbar navbar-expand-md navbar-dark bgr-dark">
    	...
    	<div class="collapse navbar-collapse" id="navbarColl">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a href="browse_questions.php" class="btn btn-danger">Browse Question</a>
				</li>
				<li class="nav-item">
					<a href="#" class="nav-link">Submitted Questions</a>
				</li>
				<li class="nav-item">
					<a href="#" class="nav-link">Profile</a>
				</li>	
				<li class="nav-item">
					<a href="../controller/logout_con.php" class="btn btn-danger">Logout</a>
				</li>															    		
			</ul>  
