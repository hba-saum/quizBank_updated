...
head("QuizBank | Register as Question Setter");
?>
<body class="bgr-light">
<?php include("includes/nav.php") ?>
	<div class="container my-5" style="max-width: 600px;">
		<h4>Register as Question Setter</h4>
		<form action="../controller/setter_con.php" class="needs-validation" id="form" method="post" novalidate>
			...
			<h5>Type</h5>
			<div class="form-check">
				<input type="radio" class="form-check-input"  id="idie"  name="type" value="0" onClick="hide_view()"  required>
				<label for="idie">Indie</label>					
			</div>
			<div class="form-check">
				<input type="radio" class="form-check-input"  id="institute"  name="type" value="1" onClick="hide_view()" required>
	...
	<script>
		let instituteInfo = '<label for="institute">Name of Institution(Currently working for)</label> <input type="text" class="form-control"  id="institute"  name="institute"  required>';
